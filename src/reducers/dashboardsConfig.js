...
export const actionTypes = {
  ...
  SET_DASHBOARDSCONFIG_SORTFILTER_DIRECTION:
    "SET_DASHBOARDSCONFIG_SORTFILTER_DIRECTION",
...
export const sortFilterData = [
  {
    id: `${sortFilterKeyData[0].id}_${sortFilterDirectionData[0].id}`,
    value: `${sortFilterKeyData[0].value} (${sortFilterDirectionData[0].value})`
  },
  {
    id: `${sortFilterKeyData[0].id}_${sortFilterDirectionData[1].id}`,
    value: `${sortFilterKeyData[0].value} (${sortFilterDirectionData[1].value})`
  },
  {
    id: `${sortFilterKeyData[1].id}_${sortFilterDirectionData[0].id}`,
    value: `${sortFilterKeyData[1].value} (${sortFilterDirectionData[0].value})`
  },
  {
    id: `${sortFilterKeyData[1].id}_${sortFilterDirectionData[1].id}`,
    value: `${sortFilterKeyData[1].value} (${sortFilterDirectionData[1].value})`
  },
  {
    id: `${sortFilterKeyData[2].id}_${sortFilterDirectionData[0].id}`,
    value: `${sortFilterKeyData[2].value} (${sortFilterDirectionData[0].value})`
  },
  {
    id: `${sortFilterKeyData[2].id}_${sortFilterDirectionData[1].id}`,
    value: `${sortFilterKeyData[2].value} (${sortFilterDirectionData[1].value})`
  }
];
...
export const DEFAULT_DASHBOARDSCONFIG_SORTFILTER_DIRECTION =
  sortFilterDirectionData[0].id;
  ...
  switch (action.type) {
    case actionTypes.SET_DASHBOARDSCONFIG_OWNERFILTER:
      return validateReducer(
        action.value,
        DEFAULT_DASHBOARDSCONFIG_OWNERFILTER
      );
    default:
      return state;
  }
...
const keyFilter = (state = DEFAULT_DASHBOARDSCONFIG_SORTFILTER_KEY, action) => {
  switch (action.type) {
    case actionTypes.SET_DASHBOARDSCONFIG_SORTFILTER_KEY:
      return validateReducer(
        action.value,
        DEFAULT_DASHBOARDSCONFIG_SORTFILTER_KEY
      );
    default:
      return state;
  }
...
const directionFilter = (
  state = DEFAULT_DASHBOARDSCONFIG_SORTFILTER_DIRECTION,
  action
) => {
  switch (action.type) {
    case actionTypes.SET_DASHBOARDSCONFIG_SORTFILTER_DIRECTION:
      return validateReducer(
        action.value,
        DEFAULT_DASHBOARDSCONFIG_SORTFILTER_DIRECTION
      );
    default:
      return state;
  }
...
export const sGetIsFetchingFromState = state =>
  sGetDashboardsConfigFromState(state).isFetching;

export const sGetSelectedIdFromState = state =>
  sGetDashboardsConfigFromState(state).selectedId;

export const sGetTextFilterFromState = state =>
  sGetDashboardsConfigFromState(state).textFilter;

export const sGetShowFilterFromState = state =>
  sGetDashboardsConfigFromState(state).showFilter;

export const sGetOwnerFilterFromState = state =>
  sGetDashboardsConfigFromState(state).ownerFilter;

export const sGetSortFilterFromState = state =>
  sGetDashboardsConfigFromState(state).sortFilter;

export const sGetViewFilterFromState = state =>
  sGetDashboardsConfigFromState(state).viewFilter;
